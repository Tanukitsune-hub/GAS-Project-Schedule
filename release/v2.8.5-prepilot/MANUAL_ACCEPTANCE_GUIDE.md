...
# 2.8.5-prepilot Manual Acceptance Guide
...
| Highest status allowed here | `READY_FOR_INDEPENDENT_REAUDIT` |
...
3. Confirm the Source A5 commit contains source/tests/tools/canonical docs/
   changelog/visualization/design/migration only.
4. Confirm the Release B5 commit contains only the two release packages and
   the Round 4 implementation report.
...
| Overall maximum status | `READY_FOR_INDEPENDENT_REAUDIT` |  |
