...
assert.match(status, /Work 0030: Code `2\.8\.17-prepilot`, source A17 and release B17/);
...
assert.match(decisions, /Work 0030 is the successor Code `2\.8\.17-prepilot` with[\s\S]*?A17\/B17/);
...
process.stdout.write(`${JSON.stringify({
  ...
  mojibake_hits: 0,
  historical_lineage: 'A14_B14_A15_B15_A16_B16_PRESERVED',
  status: 'PASS'
}, null, 2)}\n`);
