...
const placement = require('../tools/work_0037_codex_04_idle_log_finalization_placement');

const toolSource = fs.readFileSync(
  path.join(__dirname, '..', 'tools',
    'work_0037_codex_04_idle_log_finalization_placement.js'),
  'utf8'
);
...
assert.match(toolSource, /WORK_OS_CODEX_04_IDLE_LOG_FINALIZATION_REPLACEMENT_V1/);
assert.match(toolSource, /CODEX_04_IDLE_LOG_FINALIZATION_AUTOMATION_OFF_CONFIRMED/);
...
const valid = {
  schema: 'WORK_OS_CODEX_04_IDLE_LOG_FINALIZATION_REPLACEMENT_V1',
  work_id: '0037',
...
assert.throws(
  ...
  (error) => error && error.code ===
    'WORK_0037_CODEX_04_IDLE_LOG_FINALIZATION_EXECUTION_STATE_INVALID'
);

process.stdout.write(`${JSON.stringify({
  suite: 'work_0037_codex_04_idle_log_finalization_placement',
