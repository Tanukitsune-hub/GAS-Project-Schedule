# Requirements Traceability - 2.8.17-prepilot
...
Work 0030 adds the following current evidence paths:
...
| Code/release lineage and exact payload inventory | A17/B17 tools and `CURRENT_CONTRACT.json` | Local/fresh clone/CI |
...
runtime, and Gemini behavior remain `NOT_EXECUTED` in Work 0030. No API key is
