# Controlled Sandbox Trial Guide - 2.8.17-prepilot
...
Work 0030. Work 0030 does not configure or inspect a real API key, make a real
...
## Work 0030 response boundary

- Gemini completed responses are accepted only as `thought* model_output`.
...
1. Bind the exact A17 source and B17 release commits and verify checksums.
