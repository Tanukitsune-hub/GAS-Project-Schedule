...
# 2.8.7-prepilot Manual Acceptance Guide
...
| Highest status allowed here | `PHASE8B_SANDBOX_NO_GO_QUICK_DIAGNOSTIC` |
...
3. Confirm the Source A7 commit contains source/tests/tools/canonical docs/
   changelog/visualization/design/migration only.
4. Confirm the Release B7 commit contains only the two release packages and
   the Phase 8B Quick Diagnostic real-runtime implementation report.
...
| Overall maximum status | `PHASE8B_SANDBOX_NO_GO_QUICK_DIAGNOSTIC` |  |
