...
# 2.8.12-prepilot Manual Acceptance Guide
...
3. Confirm the Source A12 commit contains source/tests/tools/canonical docs/
   changelog/visualization/design/migration only.
4. Confirm the direct-child Release B12 commit contains only the two release
