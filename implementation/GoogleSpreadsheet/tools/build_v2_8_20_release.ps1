...
$releaseVersion = 'v2.8.20-prepilot'
$expectedCodeVersion = '2.8.20-prepilot'
...
$templateRoot = Join-Path $PSScriptRoot 'v2_8_20'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A20 first; package generation stopped.'
    )
  }
}
