...
$releaseVersion = 'v2.8.13-prepilot'
$expectedCodeVersion = '2.8.13-prepilot'
...
$templateRoot = Join-Path $PSScriptRoot 'v2_8_13'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A13 first; package generation stopped.'
    )
  }
}
