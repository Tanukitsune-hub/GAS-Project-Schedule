...
$releaseVersion = 'v2.8.6-prepilot-phase8c'
$expectedCodeVersion = '2.8.6-prepilot'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A6 first; package generation stopped.'
    )
  }
}
...
[pscustomobject]@{
  ...
  HighestLocalStatus = 'PHASE8B_SANDBOX_NO_GO_SETUP_BLOCKER'
} | Format-List
