...
$releaseVersion = 'v2.8.17-prepilot'
$expectedCodeVersion = '2.8.17-prepilot'
...
$templateRoot = Join-Path $PSScriptRoot 'v2_8_17'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A17 first; package generation stopped.'
    )
  }
}
