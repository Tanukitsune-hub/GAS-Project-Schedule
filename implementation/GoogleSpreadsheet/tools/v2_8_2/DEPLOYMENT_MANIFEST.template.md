...
縺薙・package縺ｯ繧ｳ繝ｼ繝臥屮譟ｻFinding菫ｮ豁｣蠕後・Phase 8B髱樊悽逡ｪSandbox蜿怜・逕ｨ縺ｧ縺吶・Phase 8B縺ｮ螳檬oogle Workspace蜿怜・縲￣hase 8C縺ｮTEST_MODE=false蜿怜・縲・螳蘖rovider謗･邯壹∝倶ｺｺ螳滓･ｭ蜍吶ヱ繧､繝ｭ繝・ヨ縺ｯ螳滓命貂医∩縺ｧ縺ｯ縺ゅｊ縺ｾ縺帙ｓ縲・
## Apps Script payload
...
`CHECKSUMS.sha256`縺ｯ縲√％縺ｮmanifest縲＿uickstart縲｀anual Acceptance Guide縲・Apps Script payload繧貞性繧package蜈ｨfile・・CHECKSUMS.sha256`閾ｪ霄ｫ繧帝勁縺擾ｼ峨・
hash繧恥ath鬆・〒險倬鹸縺励∪縺吶・
