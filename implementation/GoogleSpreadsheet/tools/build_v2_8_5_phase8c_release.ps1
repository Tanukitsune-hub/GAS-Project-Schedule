...
$releaseVersion = 'v2.8.5-prepilot-phase8c'
$expectedCodeVersion = '2.8.5-prepilot'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A5 first; package generation stopped.'
    )
  }
}
...
[pscustomobject]@{
  ...
  HighestLocalStatus = 'NO-GO_REMOTE_PUBLICATION'
} | Format-List
