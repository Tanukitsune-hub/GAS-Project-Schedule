param(
  [string]$PreparedAt = '2026-07-26T10:28:10+09:00',
  [string]$SourceCommit = 'NOT AVAILABLE - repository has no commits',
  [string]$SourceTreeStatus = (
    'Repository has no source commit; Git closeout NOT EXECUTED - ' +
    'Codex index write denied and Git identity not configured'
  )
)
...
$releaseVersion = 'v2.8.1-prepilot'
$expectedCodeVersion = '2.8.1-prepilot'
$expectedSchemaVersion = '2.2'
...
$templateRoot = Join-Path $PSScriptRoot 'phase8a'
...
$sourceTreeStatusValue = "``$SourceTreeStatus``"
