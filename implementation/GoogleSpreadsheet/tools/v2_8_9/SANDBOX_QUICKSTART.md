...
# 2.8.9-prepilot Sandbox Quickstart
...
7. Before S90, verify only the documented Setup-owned 17×3 Dashboard system
   ...
   Stop on any foreign content, ownership/control-plane issue, or other surface
   conflict; neither Diagnostic path may repair it.
...
at `PHASE8B_SANDBOX_NO_GO_DASHBOARD_NUMBER_FORMAT` until remote publication and fresh-clone proof.
