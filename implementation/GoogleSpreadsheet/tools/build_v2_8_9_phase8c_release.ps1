...
$releaseVersion = 'v2.8.9-prepilot-phase8c'
$expectedCodeVersion = '2.8.9-prepilot'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A9 first; package generation stopped.'
    )
  }
}
...
[pscustomobject]@{
  ...
  HighestLocalStatus = 'PHASE8B_SANDBOX_NO_GO_DASHBOARD_NUMBER_FORMAT'
} | Format-List
