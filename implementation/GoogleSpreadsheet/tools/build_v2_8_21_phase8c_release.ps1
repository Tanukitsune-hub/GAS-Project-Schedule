...
$releaseVersion = 'v2.8.21-prepilot-phase8c'
$expectedCodeVersion = '2.8.21-prepilot'
...
$guide = @"
# Phase 8C controlled personal qualification payload
...
[pscustomobject]@{
  ...
  HighestLocalStatus = 'READY_FOR_USER_PERSONAL_AUTOMATION_E2E'
} | Format-List
