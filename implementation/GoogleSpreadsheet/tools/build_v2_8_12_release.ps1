...
$releaseVersion = 'v2.8.12-prepilot'
$expectedCodeVersion = '2.8.12-prepilot'
...
$templateRoot = Join-Path $PSScriptRoot 'v2_8_12'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A12 first; package generation stopped.'
    )
  }
}
