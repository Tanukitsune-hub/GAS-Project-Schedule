...
$releaseVersion = 'v2.8.14-prepilot'
$expectedCodeVersion = '2.8.14-prepilot'
...
$templateRoot = Join-Path $PSScriptRoot 'v2_8_14'
...
function Assert-ExactSourceCheckout {
  ...
  if ($headCommit.ToLowerInvariant() -ne $resolvedSourceCommit.ToLowerInvariant()) {
    throw (
      ...
      'Create/checkout Source A14 first; package generation stopped.'
    )
  }
}
