...
# 2.8.14-prepilot Manual Acceptance Guide
...
3. Confirm the Source A14 commit contains source/tests/tools/canonical docs/
   changelog/visualization/design/migration only.
4. Confirm the direct-child Release B14 commit contains only the two release
