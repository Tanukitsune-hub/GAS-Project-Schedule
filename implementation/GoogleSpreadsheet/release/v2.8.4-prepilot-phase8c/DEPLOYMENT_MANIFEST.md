...
| Field | Value |
|---|---|
| Package | `v2.8.4-prepilot-phase8c` |
...
- Payload files: `22`
- `.gs` files: `21`
- Canonical payload-list SHA-256: `c5d52d37a29f2ab2ecaf7a9dde41bdbcf70afc8c4cf13f2783bb06775d616a30`
- `99_TestHarness.gs`: `EXCLUDED`
- `.clasp.json`: `EXCLUDED`

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `2242cb4b39590d8a649dab42eb31671280f11a5a198819635d02830d1bf69362` |
