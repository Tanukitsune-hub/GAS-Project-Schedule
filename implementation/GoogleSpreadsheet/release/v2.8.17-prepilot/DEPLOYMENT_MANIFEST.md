...
# Phase 8B Work 0030 Deployment Manifest
...
| Source commit | `8b4267c7ff9f156866df171107ddd5aed02d8268` |
| Release content commit | `SELF (the Git commit containing this manifest)` |
| Code Version | `2.8.17-prepilot` |
| Schema Version | `2.6` |
...
| Package prepared at | `2026-08-12T00:00:00Z` |
...
Work 0030 Gemini thinking-step parser repair. It is a candidate artifact, not a
...
| Payload files | `24` |
| `.gs` files | `23` |
| Canonical payload-list SHA-256 | `ece597b54d360c7ca398db9ceea40c75ace0c8714e950b78a8375949a8bcdf72` |

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `d1ecd003cbb8132a528b30af43f72de4452d421d8c7446a88d39ba26a1d9b00e` |
...
| `apps-script/20_GeminiProvider.gs` | `1cc7e3c970355bcbfa1d53d07143dd85a772a7af164747eebf0f06159c9dae1a` |
