...
# Work 0041 Phase 8B Deployment Manifest
...
| Payload files | `26` |
| `.gs` files | `25` |
| Canonical payload-list SHA-256 | `f1ec4f4128cd36515d8f1fddcc9c510054463dca600f4f4653b4e52e6c060c7e` |

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `51d3dd3d14708e585c189ee6116c1d7326e9011febe54e3a0b847dba4518b289` |
