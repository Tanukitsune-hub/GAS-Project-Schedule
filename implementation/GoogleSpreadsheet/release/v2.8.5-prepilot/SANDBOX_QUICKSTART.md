...
# 2.8.5-prepilot Sandbox Quickstart
...
6. Use the Manual Acceptance Guide to record the required R4 fault-injection
...
3. Record only safe error codes, timestamps, and non-sensitive screenshots.
   Never record IDs, mail content, credentials, OAuth details, or internal URLs.
...
at `NO-GO_REMOTE_PUBLICATION` until remote publication and fresh-clone proof.
