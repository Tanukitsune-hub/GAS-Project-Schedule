...
| Source commit | `859dc2e0b91bbdf925705c15b9e3f046c8bca7a6` |
...
| Package prepared at | `2026-08-11T11:59:13Z` |
...
17ﾃ・ system block to the canonical plain-text number-format contract, calls
...
- A pre-S90 Setup resume may normalize number format only after that strict
  ...
  exact 17ﾃ・ system block, flushes pending Spreadsheet writes, reacquires a
...
- `.gs` files: `23`
- Manifest files: `1`
- Canonical payload-list SHA-256: `183086dcdf69cfa93ee81b0661f6544ac923bfd38fc5190da5d6fffd64b53519`
...
|---|---|
| `apps-script/00_Config.gs` | `ced9eb863d1357ada3cd01ef6b860e261b7ebcb86e0e9f390ba2d28330645927` |
...
| `apps-script/05_GmailGateway.gs` | `6756cfc1362c6e2e2f9f7515e47d8640ca693a53391422be583f62a818bc2a81` |
| `apps-script/06_EmailPreprocessor.gs` | `febba4f009201fdf880d39dc43f54c8ff3b9bc17790ce588aa9f9c9d60394657` |
| `apps-script/07_AiAdapter.gs` | `8708693632ae8d5e8eca8d6301f55429603507d3aef9b811ead197a623466230` |
...
| `apps-script/18_Worker.gs` | `5ea13c4315c2e427964d481cf74562fa952b4bca6d40fb36e2ee582aa39949a0` |
| `apps-script/19_RuntimeSettings.gs` | `106370ebf78c81266d061f690b3448902d40bf177f283d880fe3965ac6fc618f` |
| `apps-script/20_GeminiProvider.gs` | `4885178e9a259f4f407bd5ba17fc8965effda7921579702f7ee60b1f0cc061ba` |
...
External-request scope boundary:

- `script.external_request` is present solely for the dedicated Gemini
  provider transport; no provider request is executed while building this
  package
- no Drive scope
- no mail-send scope
...
| Provider / model / endpoint / auth | `IMPLEMENTED; CREDENTIAL NOT CONFIGURED` |
