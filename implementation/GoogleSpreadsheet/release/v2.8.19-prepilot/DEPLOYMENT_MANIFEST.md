...
# Phase 8B Work 0032 Deployment Manifest
...
| Source commit | `adfcbd6cfe72f4b1f600c238a27bb37953681f81` |
...
| Package prepared at | `2026-08-17T12:00:00Z` |
...
Work 0032 Gemini runtime diagnostics hardening. It is a candidate artifact, not a
...
| Payload files | `24` |
| `.gs` files | `23` |
| Canonical payload-list SHA-256 | `f7f6e0e99bfe47a9ea1d5ec564d4d5013c4b7b9532b4cfed3f53391378e19791` |

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `d01ec576bcb6b283cdc532522277f665a76306c0788c8b6a2b9c7b6bb516dc1f` |
...
| `apps-script/20_GeminiProvider.gs` | `dfac910045b22d8f1f8bbb3418bc325731dc5a20ffaff94ac9a6ed383b36ed45` |
