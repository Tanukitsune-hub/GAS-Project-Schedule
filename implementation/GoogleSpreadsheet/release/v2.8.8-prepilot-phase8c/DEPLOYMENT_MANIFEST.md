...
| Field | Value |
|---|---|
| Package | `v2.8.8-prepilot-phase8c` |
...
- Payload files: `22`
- `.gs` files: `21`
- Canonical payload-list SHA-256: `cddefd8153de1e53a04261bfbe9758845843f07079c696a61b7b8455bbc333ac`
- `99_TestHarness.gs`: `EXCLUDED`
- `.clasp.json`: `EXCLUDED`

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `a4bf62aec07971c1593f10e150f0dd28bf8ebfdeb22cb514407101f35dfbf187` |
