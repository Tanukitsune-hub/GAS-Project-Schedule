...
# Work 0041 Phase 8C Deployment Manifest
...
|---|---|
| Work | `0041` |
| Dispatch | `0041-CODEX-01` |
| Package | `v2.8.27-prepilot-phase8c` |
...
| Package prepared at | `2026-09-05T02:43:43Z` |
| Highest local status | `READY_FOR_USER_AUTOMATIC_INBOX_SHADOW_PILOT` |
| Live runtime | `NOT_EXECUTED` |

This is a derived, non-live Work 0041 candidate artifact. The canonical
...
| Payload files | `25` |
| `.gs` files | `24` |
| Canonical payload-list SHA-256 | `526d1dd6c2a8e8e39c43dee9e843b9782cfccdeecb3c434dd0524b20f794ff06` |

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `c9a33fba89442e99bda7cfbe77e31d55b929c47336e622fa4b6ac609ba53692f` |
...
| `apps-script/10_CalendarSync.gs` | `75828fd881f234f2f705bef61a5b4444c3a3b8c37a44faf9b6ab6acf16876bf0` |
...
| `apps-script/18_Worker.gs` | `8ff2e50071164c2040cf31da3d5dda297395452e23a0a76f0041cd051c4208b3` |
