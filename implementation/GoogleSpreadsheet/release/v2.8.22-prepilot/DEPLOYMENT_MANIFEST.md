...
Work 0037 Personal Shadow Pilot boundary. Automatic discovery is restricted
to the label-gated 手動/取込 Inbox fixture and Automation remains
...
| Payload files | `24` |
| `.gs` files | `23` |
| Canonical payload-list SHA-256 | `edb4a077a6468d30c2044c4d8a79a4ce8cc10033eb0e232365320569c058bb28` |

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `ad720ca803fbf7cfd5e7a806b473fa1abf6a70c6fbb22593f117574c6bcf0e5c` |
