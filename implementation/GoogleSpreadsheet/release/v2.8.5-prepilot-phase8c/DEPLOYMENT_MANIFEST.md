...
| Source commit | `ff658bacf1e85864e4008efa32863635e446d47d` |
...
| Package prepared at | `2026-07-28T01:59:07Z` |
...
- Payload files: `22`
- `.gs` files: `21`
- Canonical payload-list SHA-256: `22686419fe675d6582e476cd3a6d14162640312a7eddb492d87fda2bd7206db3`
- `99_TestHarness.gs`: `EXCLUDED`
- `.clasp.json`: `EXCLUDED`

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `8c515c14a4be5518b0b851ac783f70d6847f84bb7de6e540e4110d99ffd63978` |
...
| `apps-script/10_CalendarSync.gs` | `3052802e44b2d8fb026384ca5d2a13b285e62e8aefb4c3356b6ef9a97c75d8e9` |
