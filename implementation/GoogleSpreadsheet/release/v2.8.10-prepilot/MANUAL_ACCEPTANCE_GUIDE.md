...
# 2.8.10-prepilot Manual Acceptance Guide
...
| Highest status allowed here | `PHASE8B_SANDBOX_NO_GO_DASHBOARD_WRITE_VISIBILITY` |
...
| Overall maximum status | `PHASE8B_SANDBOX_NO_GO_DASHBOARD_WRITE_VISIBILITY` |  |
