...
# 2.8.13-prepilot Manual Acceptance Guide
...
3. Confirm the Source A13 commit contains source/tests/tools/canonical docs/
   changelog/visualization/design/migration only.
4. Confirm the direct-child Release B13 commit contains only the two release
