...
| Field | Value |
|---|---|
| Package | `v2.8.10-prepilot-phase8c` |
...
- Payload files: `22`
- `.gs` files: `21`
- Canonical payload-list SHA-256: `03a7c87b0920a7c48a0dca6ca2029fa4b49314f57c4a22c904d6176a7e583701`
- `99_TestHarness.gs`: `EXCLUDED`
- `.clasp.json`: `EXCLUDED`

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `9bb817bd0c9db48dac402a1dbe61d902b67d1b32550f0051fd94d1320914cca3` |
