...
# 2.8.6-prepilot Manual Acceptance Guide
...
| Highest status allowed here | `PHASE8B_SANDBOX_NO_GO_SETUP_BLOCKER` |
...
3. Confirm the Source A6 commit contains source/tests/tools/canonical docs/
   changelog/visualization/design/migration only.
4. Confirm the Release B6 commit contains only the two release packages and
   the Phase 8B Setup Ledger visibility implementation report.
...
| Overall maximum status | `PHASE8B_SANDBOX_NO_GO_SETUP_BLOCKER` |  |
