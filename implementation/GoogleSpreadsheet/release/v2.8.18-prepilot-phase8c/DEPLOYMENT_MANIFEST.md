...
| Field | Value |
|---|---|
| Package | `v2.8.18-prepilot-phase8c` |
...
- Payload files: `23`
- `.gs` files: `22`
- Canonical payload-list SHA-256: `4d6d82361619f9fb8d99ba84177664fdca5a38f12f37efb20c7369230b87678a`
- `99_TestHarness.gs`: `EXCLUDED`
- `.clasp.json`: `EXCLUDED`

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `d2d6aed2ff673a579d809e20841a5e16c99afa571e0c75339af0d36de9898785` |
