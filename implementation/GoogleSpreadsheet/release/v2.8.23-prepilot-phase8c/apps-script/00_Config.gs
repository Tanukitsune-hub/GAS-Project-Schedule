...
var WorkOsConfig = Object.freeze({
  ...
  AUTOMATION_PILOT_SCOPE: 'AUTOMATIC_PERSONAL_INBOX_SHADOW_PILOT',
  AUTOMATION_PILOT_ADMISSION_MODE: 'AUTOMATIC_INBOX',
  AUTOMATION_PILOT_SOURCE_MODE: 'AUTOMATIC_INBOX_PILOT',
  AUTOMATION_PILOT_GMAIL_QUERY:
    'in:inbox -in:spam -in:trash -category:promotions -category:social -label:手動/除外',
  AUTOMATION_PILOT_MAX_MESSAGES_PER_RUN: 1,
  ...
  PROPERTIES: Object.freeze({
    ...
    AUTOMATION_PILOT_STARTED_AT:
      'WORK_OS_V2_AUTOMATIC_INBOX_PILOT_STARTED_AT',
