...
| Field | Value |
|---|---|
| Package | `v2.8.6-prepilot-phase8c` |
...
- Payload files: `22`
- `.gs` files: `21`
- Canonical payload-list SHA-256: `85e201759f2b7f1a962e9c1a14eeca2312b6acb7797808d7d651e03ab1a3404d`
- `99_TestHarness.gs`: `EXCLUDED`
- `.clasp.json`: `EXCLUDED`

| Relative path | SHA-256 |
|---|---|
| `apps-script/00_Config.gs` | `8526a5c49eb564d2af2878efa4295fb04ca90ce2362fe8f754099491db97a042` |
