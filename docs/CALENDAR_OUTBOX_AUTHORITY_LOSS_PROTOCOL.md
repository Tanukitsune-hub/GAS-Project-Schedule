...
Migration `3`
Current corrective-integration gate: `NO-GO_REMOTE_PUBLICATION` while
`REAUDIT-TR-01` corrects transfer-checksum portability; real Workspace
behavior is still `NOT_EXECUTED`
