# Calendar Outbox and Authority-Loss Protocol - Code 2.8.16-prepilot
...
CRUD, Gmail, OAuth, triggers, locks, quotas, and Work 0029 runtime operations
remain `NOT_EXECUTED`. Work 0029 does not invoke Calendar or any Apps Script
function.
