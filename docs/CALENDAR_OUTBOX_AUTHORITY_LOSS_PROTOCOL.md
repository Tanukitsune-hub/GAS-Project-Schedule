# Calendar Outbox and Authority-Loss Protocol - Code 2.8.17-prepilot
...
CRUD, Gmail, OAuth, triggers, locks, quotas, and Work 0030 runtime operations
remain `NOT_EXECUTED`. Work 0030 does not invoke Calendar or any Apps Script
function.
