# Current Verification Matrix — 2.8.12-prepilot
...
| Source/release parity and ancestry | A12→B12, manifests, checksums, exact transform | release verifiers and local gate | Local/fresh clone/CI required |
