# Current Verification Matrix - 2.8.16-prepilot
...
| Gmail decoding and exact selection | strict dual representation and labels | Gmail suites | Local; no Work 0029 Gmail runtime |
...
| Source/release identity | A16/B16 direct-child lineage, manifests, checksums | release verifiers/local gate | Local/fresh clone/CI |
...
pilot acceptance. Work 0029 does not configure or inspect a real API key.
